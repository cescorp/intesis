...
/******************************************************************************/
/*                                                                            */
/*  BACKFILL: CREA LA SECUENCIA 001-001 DE CADA TIPO DE DOCUMENTO OPERATIVO  */
/*  (FACTURA_VENTA, NOTA_VENTA, PROFORMA, AJUSTE, TRANSFERENCIA) PARA        */
/*  EMPRESAS EXISTENTES QUE SE CREARON ANTES DE AUTOMATIZAR ESTE PASO EN     */
/*  EmpresaModelo::crear().                                                  */
/*                                                                            */
/******************************************************************************/
...
SELECT
    ...
    1,
    999999999,
    'Secuencia base creada automaticamente (backfill)',
