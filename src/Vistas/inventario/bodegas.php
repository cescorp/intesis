        ...
        <form class="modal-content" id="formularioBodega" method="post" action="<?= $appUrl ?>/inventario/bodegas/crear">
            ...
            <div class="modal-body formulario-compacto">
                <div class="row g-2">
                    ...
                    <?php endif; ?>
                    <div class="<?= $esSuperusuario ? 'col-md-3' : 'col-md-4' ?>"><label class="form-label" for="bodega_codigo">Codigo</label><input type="text" class="form-control form-control-sm" id="bodega_codigo" name="codigo" maxlength="30" required></div>
                    <div class="<?= $esSuperusuario ? 'col-md-3' : 'col-md-8' ?>"><label class="form-label" for="bodega_nombre">Nombre</label><input type="text" class="form-control form-control-sm" id="bodega_nombre" name="nombre" maxlength="120" required></div>
