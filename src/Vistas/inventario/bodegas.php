                        ...
                        <table id="tablaBodegas" class="table table-hover tabla-intesis align-middle w-100">
                            ...
                            <tbody>
                                <?php foreach ($bodegas as $bodega): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($bodega['sis_empresa_nombre_comercial']) ?></td>
                                        <td><?= htmlspecialchars($bodega['inv_bodega_codigo']) ?></td>
...
<div class="modal fade modal-intesis" id="modalBodega" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <form class="modal-content" id="formularioBodega" method="post" action="<?= $appUrl ?>/inventario/bodegas/crear">
            ...
            <div class="modal-header"><div><p class="modal-etiqueta">Inventario</p><h2 class="modal-title" id="modalBodegaTitulo">Nueva bodega</h2></div><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button></div>
            <div class="modal-body formulario-compacto">
                <div class="row g-2">
                    <?php if ($esSuperusuario): ?>
                        <div class="col-md-6"><label class="form-label" for="bodega_empresa_id">Empresa</label><select class="form-control form-control-sm" id="bodega_empresa_id" name="empresa_id" required><option value="">Seleccione</option><?php foreach ($empresas as $empresa): ?><option value="<?= (int) $empresa['sis_empresa_id'] ?>"><?= htmlspecialchars($empresa['sis_empresa_nombre_comercial']) ?></option><?php endforeach; ?></select></div>
                    <?php endif; ?>
                    ...
                    <div class="col-md-3" title="Marcar como bodega principal"><div class="form-check mt-4"><input class="form-check-input" type="checkbox" id="bodega_principal" name="principal" value="1"><label class="form-check-label" for="bodega_principal">Principal</label></div></div>
                    <div class="col-md-3" title="Marcar como bodega virtual (no fisica)"><div class="form-check mt-4"><input class="form-check-input" type="checkbox" id="bodega_virtual" name="virtual" value="1"><label class="form-check-label" for="bodega_virtual">Virtual</label></div></div>
                    <div class="col-md-3" title="Permitir stock negativo"><div class="form-check mt-4"><input class="form-check-input" type="checkbox" id="bodega_negativos" name="negativos" value="1"><label class="form-check-label" for="bodega_negativos">Stock negativo</label></div></div>
                    <div class="col-md-3" title="Esta bodega no necesita aprobación en procesos de inventario"><div class="form-check mt-4"><input class="form-check-input" type="checkbox" id="bodega_autoaprobado" name="autoaprobado" value="1"><label class="form-check-label" for="bodega_autoaprobado">Auto Aprueba</label></div></div>
                </div>
            </div>
