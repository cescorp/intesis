                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end acciones-tabla">
                                                ...
                                                <?php if ($estado['sis_estado_activo'] && $permisos['estado_inactivar']): ?>
                                                    <form action="<?= $appUrl ?>/sistema/configuracion/estados/inactivar" method="post" class="d-inline formulario-confirmar"><input type="hidden" name="estado_id" value="<?= (int) $estado['sis_estado_id'] ?>"><button type="submit" class="btn btn-accion btn-inactivar" title="Inactivar estado"><i class="bi bi-toggle-off"></i></button></form>
                                                <?php endif; ?>
                    ...
                    <?php if ($panelConfiguracion === 'mensajes'): ?>
                        ...
                        <div class="table-responsive">
                            <table id="tablaMensajesError" class="table table-hover tabla-intesis align-middle w-100">
                                <thead><tr><th>Codigo</th><th>Tipo</th><th>Titulo</th><th>Modulo</th><th>Entidad</th><th>Activo</th><th class="text-end">Acciones</th></tr></thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end acciones-tabla">
                                                ...
                                                <?php if ($item['sis_mensaje_errores_activo'] && $permisos['mensaje_inactivar']): ?>
                                                    <form action="<?= $appUrl ?>/sistema/configuracion/mensajes-error/inactivar" method="post" class="d-inline formulario-confirmar"><input type="hidden" name="mensaje_id" value="<?= (int) $item['sis_mensaje_errores_id'] ?>"><button type="submit" class="btn btn-accion btn-inactivar" title="Inactivar mensaje"><i class="bi bi-toggle-off"></i></button></form>
                                                <?php endif; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end acciones-tabla">
                                                ...
                                                <?php if ($tipo['sis_estado_codigo'] === 'ACTIVO' && $permisos['tipo_inactivar']): ?>
                                                    <form action="<?= $appUrl ?>/sistema/configuracion/tipos-documento/inactivar" method="post" class="d-inline formulario-confirmar"><input type="hidden" name="tipo_documento_id" value="<?= (int) $tipo['sis_tipo_documento_id'] ?>"><button type="submit" class="btn btn-accion btn-inactivar" title="Inactivar tipo"><i class="bi bi-toggle-off"></i></button></form>
                                                <?php endif; ?>
                                    ...
                                    <tr class="fila-secuencia-fuente" data-tipo="<?= (int) $secuencia['sis_tipo_documento_id'] ?>">
                                        ...
                                        <td class="text-end acciones-tabla">
                                            ...
                                            <?php if ($secuencia['sis_estado_codigo'] === 'ACTIVO' && $permisos['secuencia_inactivar']): ?>
                                                <form action="<?= $appUrl ?>/sistema/configuracion/secuencias/inactivar" method="post" class="d-inline formulario-confirmar"><input type="hidden" name="secuencia_id" value="<?= (int) $secuencia['sis_secuencias_id'] ?>"><button type="submit" class="btn btn-accion btn-inactivar" title="Inactivar secuencia"><i class="bi bi-toggle-off"></i></button></form>
                                            <?php endif; ?>
...
<script>window.INTESIS_TIPO_SELECCIONADO = '';</script>
